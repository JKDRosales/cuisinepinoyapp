const steps = [
    {
      content: "1. Saute the ginger and onion until brownish then add the pre-cooked ox tripe then simmer for few minutes.",
    },
    {
      content: "2. Add the rice, fish sauce, salt and pepper then simmer for few minutes.",
    },
    {
      content:
